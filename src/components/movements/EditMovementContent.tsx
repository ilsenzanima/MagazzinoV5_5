  ...
  if (userRole === 'user') {
    return (
        <div className="flex flex-col items-center justify-center h-full py-20">
            ...
            <p className="text-slate-500 mb-6">Non hai i permessi necessari per modificare i movimenti.</p>
            <Link href="/movements">
                                ...
                                >
                                    {selectedItemForLine ? (
                                        <div className="flex flex-col overflow-hidden">
                                            ...
                                            <span className="text-xs text-slate-500 truncate">{selectedItemForLine.code}</span>
                                        </div>
                                    ) : (
                                        <span className="text-slate-500 text-sm">Cerca articolo...</span>
                                    )}
