...
export default function GuestPortalPage({ params }: Props) {
    ...
    useEffect(() => {
        // Controlla se c'è già un passcode salvato in sessionStorage per questo cantiere
            ...
            <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-slate-50 dark:bg-slate-900 font-sans">
                <div className="w-full max-w-md space-y-6">
                    ...
                    <div className="flex flex-col items-center gap-2 mb-2">
                        <div className="h-12 w-12 rounded-xl bg-primary flex items-center justify-center text-primary-foreground shadow-md shadow-primary/20">
                            <ShieldCheck className="h-7 w-7" />
                        </div>
                        <h2 className="text-xl font-extrabold tracking-tight text-slate-900 dark:text-white">OPI Firesafe S.r.l.</h2>
                ...
                <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="flex flex-col items-center md:items-start gap-1">
                        <h1 className="text-xl font-black tracking-tight text-slate-900 dark:text-white uppercase flex items-center gap-2">
                            <span className="bg-primary text-primary-foreground px-2 py-0.5 rounded text-sm font-bold">OPI</span>
                            Firesafe S.r.l.
                        </h1>
                ...
                <div className="space-y-4">
                    ...
                    {jobs.length === 0 ? (
                        ...
                        <div className="space-y-6">
                            {jobs.map((job) => (
                                <Card key={job.jobId} className="overflow-hidden border-slate-200/80 dark:border-slate-800 shadow-sm hover:shadow transition-shadow">
