-- Ensure delivery_notes table exists
...
-- Ensure delivery_note_items table exists
...
-- Recreate Policies for delivery_notes
...
-- Recreate Policies for delivery_note_items
