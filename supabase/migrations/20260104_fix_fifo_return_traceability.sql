-- Fix FIFO Return Traceability
-- The view currently only subtracts exits/sales but doesn't add back returns (entry)
-- This causes returned material to lose its lot association
