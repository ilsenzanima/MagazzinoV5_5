-- Migration: Restore item_model in stock_movements_view
-- Date: 2026-05-23
-- Description: The 20260514_add_waste_movement_type migration recreated stock_movements_view
--              without i.model as item_model, removing the model/variant field from all views.
--              This migration restores it in all three UNION ALL blocks.
