-- Migration: Fix Security Definer View Warning for job_batch_availability
-- Date: 2026-01-31
-- Description: Recreates the view with security_invoker = true to resolve Supabase warning.
