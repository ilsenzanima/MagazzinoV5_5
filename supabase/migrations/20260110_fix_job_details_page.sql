-- Migration: Fix missing database objects for job details
-- Date: 2026-01-10
-- Issue: Job details page returns "Commessa non trovata" because:
-- 1. stock_movements_view doesn't exist
-- 2. get_job_total_cost RPC function doesn't exist

-- =====================================================
-- 1. Create stock_movements_view
-- =====================================================
...
GRANT SELECT ON public.stock_movements_view TO anon;
GRANT ALL ON public.stock_movements_view TO service_role;

-- =====================================================
-- 2. Create get_job_total_cost RPC function
-- =====================================================
