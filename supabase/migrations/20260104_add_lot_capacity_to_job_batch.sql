-- Add original quantity/pieces to job_batch_availability view
-- This allows UI to show "Max capacity" and "Available space" when doing returns
...
SELECT 
    ...
    -- NEW: Add original capacity from purchase_items
