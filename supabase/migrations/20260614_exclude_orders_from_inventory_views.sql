-- Fix: esclude gli ordini (order_type='order') dalle view di disponibilità
-- inventario e dallo storico movimenti.
-- Gli ordini non sono merce ricevuta, quindi non devono comparire nei lotti,
-- nel report magazzino o nello storico movimenti come se fossero acquisti.
-- Una volta convertiti in acquisto, solo il nuovo acquisto conta.
...
-- ── 2. stock_movements_view ───────────────────────────────────────────────────
-- Esclude gli ordini dal blocco purchase_items (primo UNION)
