-- Fix Security Definer warning for job_batch_detailed view
-- Recreate view with SECURITY INVOKER to use the querying user's permissions

DROP VIEW IF EXISTS public.job_batch_detailed;

CREATE VIEW public.job_batch_detailed 
...
'Vista dettagliata giacenza cantiere per lotto. Usa SECURITY INVOKER per rispettare le RLS policies dell utente.';
