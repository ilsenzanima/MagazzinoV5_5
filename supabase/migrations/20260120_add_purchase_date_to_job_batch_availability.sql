-- Migration: Add purchase_date to job_batch_availability view
-- Date: 2026-01-20
-- Description: Adds purchase_date column to show the acquisition date in the return article selector
